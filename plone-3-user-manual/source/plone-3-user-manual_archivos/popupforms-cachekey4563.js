...
jQuery(function($){
    ...
    // login form
    $('#portal-personaltools a[href$=/login], #portal-personaltools a[href$=/login_formX], .discussion a[href$=/login_form]').prepOverlay(
        {
            subtype: 'ajax',
...
/* - news_overlay.js - */
// http://plone.org/portal_javascripts/news_overlay.js?original=1
$(function(){$('.newsImageContainer a').prepOverlay({subtype:'image',urlmatch:'/image_view_fullscreen$',urlreplace:'_preview'})});
